  ...
  return (
    <Container>
      ...
      <div className="row mt-3">
        ...
        <div className="col-3 mt-3">
          <span style={{ border: "1px solid blue", borderRadius: "6px", backgroundColor: messageCheck === "create a room" ? "yellow" : "white" }} onClick={() => setMessageCheck("create a room")}>Create a room!</span>
        </div>
      </div>
      <p className="border border-primary mt-3" />
