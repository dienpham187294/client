            ...
            <div className="container px-4 py-1" >
                ...
                <div className="A1Pricing_div1">
                    <ul>
                        ...
                        <li>
                            <Link to={'/posts-6'}>
                                6.  Nói tiếng anh như gió?
                            </Link>
                        </li>
                        <li>
                            <Link to={'/posts-7'}>
                                7.  Giá trị đích thực của việc học.
                            </Link>
                        </li>
                        <li>
                            <Link to={'/posts-8'}>
                                8.   Học kỹ năng với rèn luyện.
                            </Link>
                        </li>
                        <li>
                            <Link to={'/posts-9'}>
                                9.  Tiếp thu kỹ năng với giáo dục và đào tạo.
                            </Link>
                        </li>
                        <li>
                            <Link to={'/posts-10'}>
                                10.  Sinh lý thần kinh về kỹ năng: Tính mềm dẻo của não bộ và bộ nhớ cơ bắp
                            </Link>
                        </li>
                        <li>
                            <Link to={'/posts-11'}>
                                11.   Cùng bắt đầu hành trình rèn luyện kỹ năng tiếng anh nghe – nói trong 90 bài thực hành!
                            </Link>
                        </li>
                        <li>
                            <Link to={'/posts-12'}>
                                12.    1000 từ vựng thường được sử dụng nhất.
                            </Link>
                        </li>
                        <li>
                            <Link to={'/posts-13'}>
                                13.   1000 câu với từ vựng thường được sử dụng nhất.
                            </Link>
                        </li>
                    </ul>
                </div>
